...
export default function MailConf() {
  ...
  const handleVerification = async () => {
    await auth.currentUser.reload();
    if (auth.currentUser.emailVerified) navigate("/HomePage");
    else alert("L'adresse e-mail n’est pas encore vérifiée.");
  };
  ...
  return (
    <div style={{ textAlign: "center", padding: "2rem" }}>
      ...
      <button onClick={handleVerification}>J'ai vérifié mon mail</button>
    </div>
  );
}
